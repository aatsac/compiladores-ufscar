// Generated from br/ufscar/dc/compiladores/semantico/LA.g4 by ANTLR 4.13.1
...
public class LAParser extends Parser {
	...
	public static final int
		ALGORITMO=1, FIM_ALGORITMO=2, DECLARE=3, CONSTANTE_KW=4, TIPO_KW=5, PROCEDIMENTO=6, 
		FIM_PROCEDIMENTO=7, FUNCAO=8, FIM_FUNCAO=9, RETORNE=10, VAR_KW=11, REGISTRO_KW=12, 
		FIM_REGISTRO=13, LEIA=14, ESCREVA=15, SE=16, ENTAO=17, FIM_SE=18, SENAO=19, 
		CASO=20, SEJA=21, FIM_CASO=22, PARA=23, ATE=24, FIM_PARA=25, ENQUANTO=26, 
		FACA=27, FIM_ENQUANTO=28, LITERAL_KW=29, INTEIRO_KW=30, REAL_KW=31, LOGICO_KW=32, 
		VERDADEIRO=33, FALSO=34, NAO=35, E_KW=36, OU=37, IDENT=38, NUM_INT=39, 
		NUM_REAL=40, CADEIA=41, ATRIBUICAO=42, MENOR_IGUAL=43, MAIOR_IGUAL=44, 
		DIFERENTE=45, PONTO_PONTO=46, VIRGULA=47, PONTO_VIRG=48, DOIS_PONTOS=49, 
		PONTO=50, ABRE_PAR=51, FECHA_PAR=52, ABRE_COL=53, FECHA_COL=54, MENOR=55, 
		MAIOR=56, IGUAL=57, MAIS=58, MENOS=59, ASTERISCO=60, BARRA=61, PORCENTAGEM=62, 
		CIRCUNFLEXO=63, AMPERSAND=64, COMENTARIO=65, WS=66;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'var'", "'registro'", "'fim_registro'", "'leia'", "'escreva'", "'se'", 
			"'entao'", "'fim_se'", "'senao'", "'caso'", "'seja'", "'fim_caso'", "'para'", 
			"'ate'", "'fim_para'", "'enquanto'", "'faca'", "'fim_enquanto'", "'literal'", 
			"'inteiro'", "'real'", "'logico'", "'verdadeiro'", "'falso'", "'nao'", 
			"'e'", "'ou'", null, null, null, null, "'<-'", "'<='", "'>='", "'<>'", 
			"'..'", "','", "';'", "':'", "'.'", "'('", "')'", "'['", "']'", "'<'", 
			"'>'", "'='", "'+'", "'-'", "'*'", "'/'", "'%'", "'^'", "'&'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "ALGORITMO", "FIM_ALGORITMO", "DECLARE", "CONSTANTE_KW", "TIPO_KW", 
			"PROCEDIMENTO", "FIM_PROCEDIMENTO", "FUNCAO", "FIM_FUNCAO", "RETORNE", 
			"VAR_KW", "REGISTRO_KW", "FIM_REGISTRO", "LEIA", "ESCREVA", "SE", "ENTAO", 
			"FIM_SE", "SENAO", "CASO", "SEJA", "FIM_CASO", "PARA", "ATE", "FIM_PARA", 
			"ENQUANTO", "FACA", "FIM_ENQUANTO", "LITERAL_KW", "INTEIRO_KW", "REAL_KW", 
			"LOGICO_KW", "VERDADEIRO", "FALSO", "NAO", "E_KW", "OU", "IDENT", "NUM_INT", 
			"NUM_REAL", "CADEIA", "ATRIBUICAO", "MENOR_IGUAL", "MAIOR_IGUAL", "DIFERENTE", 
			"PONTO_PONTO", "VIRGULA", "PONTO_VIRG", "DOIS_PONTOS", "PONTO", "ABRE_PAR", 
			"FECHA_PAR", "ABRE_COL", "FECHA_COL", "MENOR", "MAIOR", "IGUAL", "MAIS", 
			"MENOS", "ASTERISCO", "BARRA", "PORCENTAGEM", "CIRCUNFLEXO", "AMPERSAND", 
			"COMENTARIO", "WS"
		};
	}
	...
	public final DeclaracoesContext declaracoes() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 376L) != 0)) {
				{
				{
				setState(106);
				decl_local_global();
	...
	public static class Declaracao_localContext extends ParserRuleContext {
		...
		public TerminalNode CONSTANTE_KW() { return getToken(LAParser.CONSTANTE_KW, 0); }
		...
		public TerminalNode TIPO_KW() { return getToken(LAParser.TIPO_KW, 0); }
	...
	public static class Tipo_basicoContext extends ParserRuleContext {
		public TerminalNode LITERAL_KW() { return getToken(LAParser.LITERAL_KW, 0); }
		public TerminalNode INTEIRO_KW() { return getToken(LAParser.INTEIRO_KW, 0); }
		public TerminalNode REAL_KW() { return getToken(LAParser.REAL_KW, 0); }
		public TerminalNode LOGICO_KW() { return getToken(LAParser.LOGICO_KW, 0); }
	...
	public final Valor_constanteContext valor_constante() throws RecognitionException {
		...
		try {
			...
			setState(176);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 3874060500992L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public static class RegistroContext extends ParserRuleContext {
		public TerminalNode REGISTRO_KW() { return getToken(LAParser.REGISTRO_KW, 0); }
	...
	public final Declaracao_globalContext declaracao_global() throws RecognitionException {
		...
		try {
			...
			case PROCEDIMENTO:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & -9223371761765989376L) != 0)) {
					{
					{
					setState(199);
					cmd();
	...
	public static class ParametroContext extends ParserRuleContext {
		...
		public TerminalNode VAR_KW() { return getToken(LAParser.VAR_KW, 0); }
		public List<TerminalNode> VIRGULA() { return getTokens(LAParser.VIRGULA); }
		public TerminalNode VIRGULA(int i) {
			return getToken(LAParser.VIRGULA, i);
		}
	...
	public static class Op2Context extends ParserRuleContext {
		public TerminalNode ASTERISCO() { return getToken(LAParser.ASTERISCO, 0); }
		public TerminalNode BARRA() { return getToken(LAParser.BARRA, 0); }
	...
	public static class Parcela_nao_unarioContext extends ParserRuleContext {
		public TerminalNode AMPERSAND() { return getToken(LAParser.AMPERSAND, 0); }
		public IdentificadorContext identificador() {
			return getRuleContext(IdentificadorContext.class,0);
		}
		public TerminalNode CADEIA() { return getToken(LAParser.CADEIA, 0); }
	...
	public final Exp_relacionalContext exp_relacional() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 252263151783903232L) != 0)) {
				{
				setState(504);
				op_relacional();
				setState(505);
	...
	public static class Op_logico_2Context extends ParserRuleContext {
		public TerminalNode E_KW() { return getToken(LAParser.E_KW, 0); }
